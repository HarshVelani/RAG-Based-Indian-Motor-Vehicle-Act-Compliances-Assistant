...
--> MVA SECTION: 2A. e-cart and e-rickshaw.
...
--> MVA SECTION: 6. Restrictions on the holding of driving licences.
...
--> MVA SECTION: 12. Licensing and regulation of schools or establishments for imparting instruction in driving of motor vehicles.
...
--> MVA SECTION: 13. Extent of effectiveness of licences, to drive motor vehicles.
...
--> MVA SECTION: 20. Power of Court to disqualify.
    ...
    (3) A Court shall, unless for special reasons to be recorded in writing it thinks fit to order otherwise, order the disqualification of a person-
        ...
        (c) who is convicted of an offence punishable under section 192: Provided that the period of disqualification shall not exceed, in the case referred to in clause (a), five years, or, in the case referred to in clause (b), two years or, in the case referred to in clause (c), one year.
...
--> MVA SECTION: 25. Transfer of endorsement and issue of driving licence free from endorsement.
...
--> MVA SECTION: 27. Power of Central Government to make rules.
...
--> MVA SECTION: 28. Power of State Government to make rules.
...
--> MVA SECTION: 31. Disqualifications for the grant of conductor’s licence.
...
--> MVA SECTION: 35. Power of Court to disqualify.
...
--> MVA SECTION: 43. Temporary registration.
...
--> MVA SECTION: 47. Assignment of new registration mark on removal to another State.
...
--> MVA SECTION: 51. Special provisions regarding motor vehicle subject to hire-purchase agreement, etc.
...
--> MVA SECTION: 55. Cancellation of registration.
...
--> MVA SECTION: 61. Application of Chapter to trailers.
...
--> MVA SECTION: 63. Maintenance of State Registers of Motor Vehicles.
...
--> MVA SECTION: 64. Power of Central Government to make rules.
    ...
    - The Central Government may make rules to provide for all or any of the following matters, namely:-
        ...
        (h) the form in which and the manner in which the application for “No Objection Certificate” shall be made under sub-section (1) of section 48 and the form of receipt to be issued under sub-section (2) of section 48; (i) the matters that are to be complied with by an applicant before no objection certificate may be issued under section 48;
...
--> MVA SECTION: 65. Power of State Government to make rules.
    Definition: This section gives the State Government the power to make rules regarding various provisions related to motor vehicles, including licensing, registration, control of transport vehicles, regulation of traffic, and enforcement of penalties. These rules help implement the Act at the state level, ensuring compliance with local requirements and conditions.
    ...
    (2) Without prejudice to the generality of the foregoing power, such rules may provide for-
        ...
        (h) the exemption of prescribed persons or prescribed classes of persons from payment of all or any portion of the fees payable under this Chapter;(i) the forms, other than those prescribed by the Central Government, to be used for the purpose of this Chapter;
        ...
        (k) the amount or amounts under sub-section (13) of section 41 or sub-section (7) of section 47 or sub-section (4) of section 49 or sub-section (5) of section 50;(l) the extension of the validity of certificates of fitness pending consideration of applications for their renewal;
...
--> MVA SECTION: 66. Necessity for permits.
    Definition: This section states that a motor vehicle owner cannot use their vehicle as a transport vehicle in a public place without a permit. This applies whether or not the vehicle is carrying passengers or goods. 
    ...
    (3) The provisions of sub-section (1) shall not apply-
        ...
        (b) to any transport vehicle owned by a local authority or by a person acting under contract with alocal authority and used solely for road cleansing, road watering or conservancy purposes;
    ...
    - Punishments & Fine :- Maximum fine of ten thousand rupees for first offence and ten thousand rupees for second or subsequent offence.
    
--> MVA SECTION: 66A. National Transportation Policy.
    Definition: This section empowers the Central Government to develop a comprehensive transportation policy in consultation with State Governments and other agencies, aiming to establish a planning framework for passenger and goods transportation across the country.
...
--> MVA SECTION: 66B. No bar against permit holders to apply and hold licences under schemes.
    Definition: This section states that permit holders can apply for and hold licenses under schemes. This means that permit holders can apply for licenses issued under schemes for transportation. 
...
--> MVA SECTION: 67. Power to State Government to control road transport.
    Defination: This section gives the state government the power to control road transport. The state government can use this power to improve transportation services, prevent road damage, and promote fair competition. 
...
--> MVA SECTION: 68. Transport Authorities.
    Definition: This section defines the State Transport Authority (STA) and Regional Transport Authorities (RTA). These authorities are responsible for managing transportation in the state and regions. 
    ...
    (3) The State Transport Authority and every Regional Transport Authority shall give effect to any directions issued under section 67 and the State Transport Authority shall, subject to such directions and save as otherwise provided by or under this Act, exercise and discharge throughout the State the following powers and functions, namely:-
        ...
        (ca) Government to formulate routes for applying stage carriages;
...
--> MVA SECTION: 69. General provision as to applications for permits.
    Definition: This section states that any application for a vehicle permit must be submitted to the Regional Transport Authority (RTA) of the region where the vehicle is intended to be used; essentially, it outlines the process and location for applying for a permit to operate a commercial vehicle within a specific area, ensuring proper jurisdiction for permit issuance. 
...
--> MVA SECTION: 70. Application for stage carriage permit.
    Definition: This section pertains to the application process for a "stage carriage permit," which essentially means a permit required to operate a public service vehicle like a bus on a fixed route, carrying multiple passengers at separate fares for different stages of the journey; essentially, it allows a vehicle to pick up and drop off passengers at designated stops along a specific route. 
...
--> MVA SECTION: 71. Procedure of Regional Transport Authority in considering application for stage carriage permit.
    Defination: This section outlines the procedure a Regional Transport Authority (RTA) must follow when considering an application for a "stage carriage permit," essentially meaning a permit to operate a bus service on a fixed route, and specifies that the RTA must consider the overall objectives of the Act while evaluating the application, including factors like route feasibility, timetable compliance, and potential impact on traffic conditions; it also allows the RTA to refuse a permit if the proposed schedule seems likely to violate speed limits, but with the option for the applicant to amend their timetable before denial. 
    ...
    (3) 
        ...
        (d) After reserving such number of permits as is referred to in clause (c), the Regional Transport Authority shall in considering an application have regard to the following matters, namely:-
            ...
            (iii) such other matters as may be prescribed by the State Government: Provided that, other conditions being equal, preference shall be given to applications for permits from-
                ...
                (iv) any other class or category of persons, as the State Government may, for reasons to be recorded in writing consider necessary.
    Explanation: For the purposes of this section “company” means any body corporate, and includes afirm or other association ofindividuals; and “director”, in relation to a firm, means a partner in the firm.
    - STATE AMENDMENTS Kerala 
        - Amendment of section 71.-In section 71 of the Motor Vehicles Act, 1988 (Central Act 59 of 1988), hereinafter referred to as the principal Act, in sub-section (4).
            ...
            (ii) for the words “any company”, the words “any co-operative society or to any company” shall be substituted. [Vide Kerala Act 12 of 1993, sec. 2.]
    - Punishments & Fine :-

--> MVA SECTION: 72. Grant of stage carriage permits.
    Definition: This section pertains to the "Grant of Stage Carriage Permits," which essentially means that a Regional Transport Authority (RTA) can issue a permit allowing a vehicle operator to run a public transport service like a bus on a specified route, with conditions regarding the number of trips, timings, and vehicle specifications, subject to an application made by the operator under Section 70 of the Act; essentially enabling the operation of a fixed-route passenger service within a designated area.  
    ...
    (2) The Regional Transport Authority, if it decides to grant a stage carriage permit, may grant the permit for a stage carriage of a specified description and may, subject to any rules that may be made under this Act, attach to the permit any one or more of the following conditions, namely:-
        ...
        (xxiv) any other conditions which may be prescribed.Provided that the Regional Transport Authority may waive any such condition for a stage carriage permit operating in a rural area, as it deems fit.
    - Punishments & Fine :-

--> MVA SECTION: 73. Application for contract carriage permit.
    Definition: This section pertains to the application process for a "contract carriage permit," which means that a vehicle owner must submit an application to the Regional Transport Authority if they want to operate a vehicle for carrying passengers under a contract basis, specifying details like the vehicle type, seating capacity, and the area where the service will be provided. 
...
--> MVA SECTION: 74. Grant of contract carriage permit.
    Definition: This section allows the Regional Transport Authority (RTA) to grant a contract carriage permit. This permit is used for hire and reward purposes, and is the most common type of permit for this purpose. 
    ...
    (2) The Regional Transport Authority, if it decides to grant a contract carriage permit, may, subject to any rules that may be made under this Act, attach to the permit any one or more of the following conditions, namely:-
        ...
        (xiii) any other conditions which may be prescribed.Provided that the Regional Transport Authority may in the interests of last mile connectivity waive any such condition in respect of any such types of vehicles as may be specified by the Central Government.
    (3)
...
--> MVA SECTION: 75. Scheme for renting of motor cabs.
    Definition: This section regulates the business of renting motor cabs and motor cycles. The Central Government can make a scheme for this purpose. 
...
--> MVA SECTION: 76. Application for private service vehicle permit.
    Definition: This section pertains to the application process for a "private service vehicle permit," which means that a vehicle owner can apply to the Regional Transport Authority (RTA) to use their vehicle for carrying passengers, not for hire or reward, but specifically for their own business or company needs within a designated area or route.
...
--> MVA SECTION: 77. Application for goods carriage permit.
    Definition: this section deals with the application for a goods carriage permit. A goods carriage permit allows a person to use a motor vehicle to transport goods for hire or reward, or for a business. 
...
--> MVA SECTION: 78. Consideration of application for goods carriage permit.
    Definition: This section deals with how the Regional Transport Authority (RTA) considers an application for a goods carriage permit. 
...
--> MVA SECTION: 79. Grant of goods carriage permit.
    Definition: This section allows a local transportation authority to issue a permit to a goods vehicle to operate within a state. The permit can be issued for specific areas or routes. 
...
--> MVA SECTION: 80. Procedure in applying for and granting permits.
    Definition: This section outlines the procedure for applying for and obtaining any kind of permit, stating that an application for a permit can be made at any time and the relevant authorities should not usually refuse a permit application if it is made according to the Act; essentially detailing the process for acquiring a permit to operate a vehicle for commercial transport purposes like carrying passengers or goods. 
...
--> MVA SECTION: 81. Duration and renewal of permits.
    Definition: This section governs the duration and renewal of permits. It states that most permits are valid for five years from the date of issue or renewal. 
...
--> MVA SECTION: 82. Transfer of permit.
    Definition: This section deals with the transfer of a permit. It states that a permit can only be transferred from one person to another with the permission of the transport authority that granted it. 
...
--> MVA SECTION: 83. Replacement of vehicles.
    Definition: This section allows the holder of a permit to replace a vehicle with another vehicle of the same nature. The authority that granted the permit must also permit the replacement. 
...
--> MVA SECTION: 84. General conditions attaching to all permits.
    Definition: This section lists the general conditions that apply to all permits.
...
--> MVA SECTION: 85. General form of permits.
    Definition: This section states that all permits issued under the Act must be complete and include all the necessary information and conditions. A permit is an official document that allows someone to drive or operate a vehicle. 
...
--> MVA SECTION: 86. Cancellation and suspension of permits.
    Definition: This section allows the transport authority to cancel or suspend a permit if certain conditions are not met. 
...
--> MVA SECTION: 87. Temporary permits.
    Definition: This section allows the State Transport Authority (STA) to issue temporary permits for transport vehicles for a limited period. These permits can be issued without following the procedure laid out in section 80. 
...
--> MVA SECTION: 88. Validation of permits for use outside region in which granted.
    Definition: This section validates permits for use outside the region where they were granted. This section states that permits are not valid across regions unless countersigned by the Regional Transport Authority (RTA) of the other region. 
...
--> MVA SECTION: 88A. Power of Central Government to make schemes for national, multimodal and inter-State transport of passengers and goods.
    Definition: This section gives the Central Government the power to create transportation plans for the country. This includes plans for inter-state and national transportation of passengers and goods. The Central Government can also change existing vehicle permits and issue or change licenses for these plans. 
    (1) Notwithstanding anything contained in this Act, the Central Government may, by notification in the Official Gazette, modify any permit issued under this Act or make schemes for national, multimodal and inter-State transportation of goods or passengers, and issue or modify licences under, such scheme for the following purposes, namely:-
        ...
        (k) such other matters as the Central Government may deem fit: Provided that the Central Government may, before taking any action under this sub-section seek concurrence of the State Governments.
...
--> MVA SECTION: 89. Appeals.
    Definition: This section covers appeals to the State Transport Appellate Tribunal. This tribunal can be appealed to by anyone who is aggrieved by certain actions of the State or a Regional Transport Authority. 
    (1) Any person-
...
--> MVA SECTION: 90. Revision.
    Definition: This section deals with revisions against orders made by State or Regional Transport Authorities. The State Transport Appellate Tribunal can review these orders and make new orders if it finds the original order to be illegal or improper. 
...
--> MVA SECTION: 91. Restriction of hours of work of drivers.
    Definition: This section restricts the hours that drivers can work. It also specifies the hours of work for drivers of transport vehicles. 
    (1) The hours of work of any person engaged for operating a transport vehicle shall be such as provided in the Motor Transport Workers Act, 1961 (27 of 1961).
...
--> MVA SECTION: 92. Voidance of contracts restrictive of liability.
    Definition: This section states that contracts that restrict liability for passengers in a stage or contract carriage are void. This includes contracts that limit the enforcement of liability. 
...
--> MVA SECTION: 93. Agent or canvasser or aggregator to obtain licence.
    Definition: This section states that anyone who wants to work as an agent, canvasser, or aggregator must get a license from the state government. 
    ...
    - Punishments & Fine :- Punishment as a Court Challan for first and subsequent offence.

--> MVA SECTION: 94. Bar on jurisdiction of Civil Courts.
    Definition: This section prevents civil courts from hearing cases related to the grant of a permit or license under the Act. It also prevents civil courts from issuing injunctions against actions taken by authorities under the Act. 
...
--> MVA SECTION: 95. Power of State Government to make rules as to stage carriages and contract carriages.
    Definition: This section allows state governments to make rules for stage carriages, contract carriages, and passenger conduct on these vehicles. 
...
--> MVA SECTION: 96. Power of State Government to make rules for the purposes of this Chapter.
    Definition: This section gives the state government the power to make rules for the purposes of the chapter.
    (1) A State Government may make rules for the purpose of carrying into effect the provisions of this Chapter.
...
--> MVA SECTION: 97. Definition.
    Definition: This section defines "road transport service" as the use of motor vehicles to transport passengers or goods for hire or reward. This definition applies to the chapter of the MVA that deals with special provisions relating to state transport undertakings.
...
--> MVA SECTION: 98. Chapter to override Chapter V and other laws.
    Definition: This section states that the provisions of this chapter will prevail over Chapter V and other laws. This means that the rules and orders made under this chapter will take effect even if they conflict with Chapter V or any other law. 
    - The provisions of this Chapter and the rules and orders made thereunder shall have effect notwithstanding anything inconsistent the rewith contained in Chapter V or in any other law for the time being in force or in any instrument having effect by virtue of any such law.
    - Punishments & Fine :-

--> MVA SECTION: 99. Preparation and publication of proposal regarding road transport service of a State transport undertaking.
    Definition: This section covers the preparation and publication of proposals for road transport services by State transport undertakings. 
...
--> MVA SECTION: 100. Objection to the proposal.
    Definition: This section essentially allows any person to raise objections against a proposed transportation scheme published by the State Government within a 30-day window, giving them the opportunity to be heard before the government finalizes the plan, which could include approving or modifying the proposal based on the objections received; essentially, it is the "right to object to a proposed transport scheme" as per the Act. 
...
--> MVA SECTION: 101. Operation of additional services by a State transport undertaking in certain circumstances.
    Definition: This section allows state transport undertakings to run additional services for passengers on special occasions. This includes transportation to and from fairs and religious gatherings. 
...
--> MVA SECTION: 102. Cancellation or modification of scheme.
    Definition: This section allows the state government to modify or cancel an approved scheme for state transport undertakings. This can be done if the government believes it is in the public interest. 
...
--> MVA SECTION: 103. Issue of permits to State transport undertakings.
    Definition: This section deals with the issue of permits to state transport undertakings. The State Transport Authority or Regional Transport Authority issues permits for stage carriage, goods carriage, and contract carriage. 
    ...
    - STATE AMENDMENTS Karnataka
        ...
        - Amendment of section 103.
            - In section 103 of the Motor Vehicles Act, 1988 (Central Act 59 of 1988), after sub-section (1), the following shall be inserted, namely:-
...
--> MVA SECTION: 104. Restriction on grant of permits in respect of a notified area or notified route.
    Definition: This section states that if a specific area or route has been "notified" (meaning officially designated) by the government, the State Transport Authority or Regional Transport Authority cannot grant any permits for operating vehicles in that area or route unless it aligns with a pre-published scheme related to that notified area, essentially restricting the issuance of permits to only those operating in accordance with the designated plan; this primarily applies to situations where a State Transport Undertaking is already providing services on a particular route. 
    ...
    - Punishments & Fine :- Maximum fine of five hundred rupees for first offence and one thousand and five hundred(fifteen hundred) rupees for second or subsequent offence.

--> MVA SECTION: 105. Principles and method of determining compensation and payment there of.
    Definition: This section defines the principles and methods for determining compensation and payment. This section applies when a permit is canceled or modified by the State transport undertaking. 
    ...
    (4) Where, in exercise of the powers conferred by clause (b) or sub-clause (i) or sub-clause (ii) of clause (c) of sub-section (2) of section 103, any existing permit is cancelled or the terms thereof are modified so as to prevent the holder of the permit from using any vehicle authorised to be used thereunder for the full period from which the permit, would otherwise have been effective, the compensation payableto the holder of the permit for each vehicle affected by such cancellation or modification shall be computed as follows:-
        ...
        (b) for part of a month not exceeding fifteen days of the unexpired period of the permit One hundred rupees: Provided that the amount of compensation shall, in no case, be less than four hundred rupees.
...
--> MVA SECTION: 106. Disposal of article found in vehicles.
    Definition: This section deals with the disposal of items found in vehicles operated by state transport undertakings. 
...
--> MVA SECTION: 107. Power of State Government to make rules.
    Definition: This section gives the state government the power to make rules to carry out the provisions of the chapter. 
...
--> MVA SECTION: 108. Certain powers of State Government exercisable by the Central Government.
    Definition: This section states that the Central Government can exercise certain powers of the State Government in relation to inter-state routes and areas. 
...
--> MVA SECTION: 109. General provision regarding construction and maintenance of vehicles.
    Definition: This section deals with the construction and maintenance of vehicles. It states that vehicles should be built and maintained so that the driver can control them at all times. 
...
--> MVA SECTION: 110. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules about the construction, equipment, and maintenance of motor vehicles and trailers. 
...
--> MVA SECTION: 110A. Recall of motor vehicles.
    Definition: This section allows the Central Government to order manufacturers to recall motor vehicles of a specific type or variant. This section was added to the Act in 2019. 
...
--> MVA SECTION: 110B. Type approval certificate and testing agencies.
    ...
    (4) The testing agencies shall conduct tests on vehicles drawn from the production line of the manufacturer or obtained otherwise to verify the conformity of such vehicles to the provisions of this Chapter and the rules and regulations made there under.
...
--> MVA SECTION: 111. Power of State Government to make rules.
    Definition: This section gives the state government the power to make rules for the construction, equipment, and maintenance of motor vehicles and trailers. 
...
--> MVA SECTION: 112. Limits of speed.
    Definiton: This section limits the speed at which a motor vehicle can be driven on public roads. It also states that no one can drive below the minimum speed limit. 
    ...
    - Punishments & Fine :- 
        (1) For Light Motor Vehicle(LMV), Maximum fine of two thousand rupees for first offence and two thousand rupees for second or subsequent offence.
        (2) For Mechanic Motor Vehicle(MMV) and Heavy Transport Vehicle(HTV), Maximum fine of four thousand rupees for first offence and four thousand rupees for second or subsequent offence.

--> MVA SECTION: 113. Limits of weight and limitations on use.
    Definition: This section states that no person can drive a motor vehicle on a public road if its weight (either unladen or laden) exceeds the limits specified in its registration certificate; essentially prohibiting overloading of vehicles. 
...
--> MVA SECTION: 114. Power to have vehicle weighed.
    Definition: This section gives an authorized Motor Vehicles Department officer the power to have a vehicle weighed. This section applies to goods vehicles and trailers. 
...
--> MVA SECTION: 115. Power to restrict the use of vehicles.
    Definition: This section gives the state government the power to restrict or prohibit the use of vehicles. This can be done to ensure public safety, convenience, or to manage road conditions. 
    ...
    - Punishments & Fine :- Maximum fine of twenty thousand rupees for first offence and twenty thousand rupees for second or subsequent offence.

--> MVA SECTION: 116. Power to erect traffic signs.
    Definition: This section gives the state government and authorized authorities the power to erect traffic signs. The purpose of these signs is to manage traffic, inform the public about road restrictions, and set speed limits. 
    (1) 
...
--> MVA SECTION: 117. Parking places and halting stations.
    Definition: This section deals with parking places and halting stations. It gives the state government or an authorized authority the power to determine where motor vehicles can stop. 
    - The State Government or any authority authorised in this behalf by the State Government may, in consultation with the local authority having jurisdiction in the area concerned, determine places at which motor vehicles may stand either indefinitely or for a specified period of time, and may determine the places at which public service vehicles may stop for a longer time than is necessary for the taking up and setting down of passengers. Provided that the State Government or the authorised authority shall, give primacy to the safety of road users and the free flow of traffic in determining such places: Provided further that for the purpose of this section the National Highways Authority of India, constituted under the National Highways Authority of India Act, 1988 (68 of 1988) or any other agency authorised by the Central Government, may also determine such places.
    - Punishments & Fine :-

--> MVA SECTION: 118. Driving regulations.
    Definition: This section allows the central government to make rules for driving motor vehicles. This includes the power to create regulations that prohibit certain behaviors while driving, such as using a mobile phone. 
    - The Central Government may, by notification in the Official Gazette, make regulations for the driving of motor vehicles.
    - Punishments & Fine :-

--> MVA SECTION: 119. Duty to obey traffic signs.
    Definition: This section states that drivers must obey traffic signs and directions from police officers. 
...
--> MVA SECTION: 120. Vehicles with left hand control.
    Definition: This section states that a person cannot drive a left-hand drive vehicle in a public place unless it has a working signaling device. 
...
--> MVA SECTION: 121. Signals and signalling devices.
    Definition: This section deals with signals and signaling devices that drivers must use to indicate their intentions.
    - The driver of a motor vehicle shall make such signals and on such occasions as may be prescribed by the Central Government: Provided that the signal of an intention to turn to the right or left or to stop-
...
--> MVA SECTION: 123. Riding on running board, etc.
    Definition: This section states that "no person driving or in charge of a motor vehicle shall carry any person or permit any person to be carried on the running board or otherwise than within the body of the vehicle," essentially prohibiting people from riding on the running board or any external part of a moving vehicle other than the designated passenger area inside the vehicle body. 
...
--> MVA SECTION: 124. Prohibition against travelling without pass or ticket.
    Definition: This section prohibits traveling without a valid pass or ticket in a stage carriage. 
...
--> MVA SECTION: 125. Obstruction of driver.
    Definition: This section states that no one can obstruct a driver while they are driving a motor vehicle. This includes standing, sitting, or placing anything in a way that interferes with the driver's control of the vehicle. 
...
--> MVA SECTION: 126. Stationary vehicles.
    Definition: This section states that a motor vehicle cannot be left stationary in a public place unless the driver is present or certain safety measures are taken. 
...
--> MVA SECTION: 127. Removal of motor vehicles abandoned or left unattended on a public place.
    Definition: This section allows police officers to authorize the removal of abandoned or unattended vehicles from public places. This includes vehicles that are parked illegally or are creating a traffic hazard. 
...
--> MVA SECTION: 128. Safety measures for drivers and pillion riders.
    Definition: This section covers safety measures for drivers and pillion riders of two-wheeled motor cycles. 
...
--> MVA SECTION: 129. Wearing of protective headgear.
    Definition: This section Defines that people over the age of four wear a protective headgear while riding a motorcycle in a public place. This includes the rider and the passenger. 
...
--> MVA SECTION: 130. Duty to produce licence and certificate of registration.
    Definition: This section states that any driver of a motor vehicle must produce their driving license for examination upon demand by a uniformed police officer in any public place; essentially, it outlines the duty to present one's license and registration certificate when requested by authorities. 
...
--> MVA SECTION: 131. Duty of the driver to take certain precautions at unguarded railway level crossing.
    Definition: This section states that drivers must take precautions at unguarded railway crossings. 
...
--> MVA SECTION: 132. Duty of driver to stop in certain cases.
    Definition: This section states that a driver must stop their vehicle in certain situations. This includes when a police officer or an animal owner asks them to stop. 
    (1) The driver of a motor vehicle shall cause the vehicle to stop and remain stationary so long as may for such reasonable time as may be necessary, but not exceeding twenty four hours-
        ...
        (b) when required to do so by any person in charge of an animal if such person apprehends that the animal is, or being alarmed by the vehicle will become, unmanageable, or and he shall give his name and address and the name and address of the owner of the vehicle to any person affected by any such accident or damage who demands it provided such person also furnishes his name and address.
    ...
    - Punishments & Fine :- Maximum fine of two thousand rupees for first offence and two thousand rupees for second or subsequent offence.

--> MVA SECTION: 133. Duty of owner of motor vehicle to give information.
    Definition: This section states that the owner of a motor vehicle involved in an offence is legally obligated to provide all information regarding the driver or conductor's name, address, and license details to any police officer who requests it; essentially, the owner must disclose the driver's identity if their vehicle is involved in a traffic violation or accident. 
...
--> MVA SECTION: 134. Duty of driver in case of accident and injury to a person.
    Definition: This section states that if a driver is involved in an accident causing injury to a person, they have a legal duty to take all reasonable steps to secure medical attention for the injured person by conveying them to the nearest medical practitioner or hospital, and to report the accident to the police station as soon as possible, if no police officer is present at the scene; essentially outlining the driver's responsibilities in case of an accident with injuries. 
...
--> MVA SECTION: 134A. Protection of Good Samaritans.
    Defintion: This section protects Good Samaritans from civil or criminal action in case of injuries or deaths that occur during a motor vehicle accident. 
...
--> MVA SECTION: 135. Schemes to be framed for the investigation of accident cases and wayside amenities, etc.
    Definition: This section empowers the State Government to formulate schemes for thoroughly investigating motor vehicle accident cases and providing necessary wayside amenities like traffic aid posts, truck parking areas, and other facilities along highways, aimed at enhancing road safety and public convenience; essentially allowing for a detailed analysis of accident causes and providing support infrastructure for travelers. 
...
--> MVA SECTION: 136. Inspection of vehicle involved in accident.
    Definition: This section states that if a motor vehicle is involved in an accident, a person authorized by the State Government can inspect the vehicle, including entering premises where it is located to remove it for examination, to gather evidence related to the accident; the vehicle must be returned to the owner within 24 hours after inspection. 
...
--> MVA SECTION: 136A. Electronic monitoring and enforcement of road safety.
    Definition: This section states to use electronic monitoring to enforce road safety. The section was added in 2019. 
...
--> MVA SECTION: 137. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules for various matters related to motor vehicles. These rules can be made by notification in the Official Gazette and the Electronic Gazette. 
    - The Central Government may make rules to provide for all or any of the following matters, namely:-
...
--> MVA SECTION: 138. Power of State Government to make rules.
    Defintion: This section gives state governments the power to make rules for road safety and other matters. These rules can be made for carrying out the provisions of the Act, and they must not conflict with rules made by the Central Government. 
    (1) The State Government may make rules for the purpose of carrying into effect the provisions of this Chapter other than the matters specified in sectio 137.    
    ...
    (2) Without prejudice to the generality of the foregoing power, such rules may provide for-
        ...
        (g) prohibiting the taking hold of or mounting of a motor vehicle in motion; (h) prohibiting the use of foot-paths or pavements by motor vehicles;
        (i) generally, the prevention of danger, injury or annoyance to the public or any person, or of danger or injury to property or of abstruction to traffic;
        (j) any other matter which is to be, or may be, prescribed.
    - Punishments & Fine :-

# CHAPTER IX - MOTOR VEHICLES TEMPORARILY LEAVING OR VISITING INDIA
--> MVA SECTION: 139. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules for the regulation of motor vehicles and their drivers. The rules can be made by notification in the Official Gazette. 
    ...
    (2) For the purpose of facilitating and regulating the services of motor vehicles operating between India and any other country under any reciprocal arrangement and carrying passengers or goods or both by road for hire or reward, the Central Government may, by notification in the Official Gazette, make rules with respect to all or any of the following matters, namely:-
        ...
        (c) the conditions subject to which persons employed as drivers and conductors of such motorvehicles may enter or leave India;
...
# CHAPTER X - LIABILITY WITHOUT FAULT IN CERTAINCASES
--> MVA SECTION: 140. Liability to pay compensation in certain cases on the principle of no fault.
    - This section is omitted by s.50, ibid, (w.e.f. 1-4-2022).
    - Punishments & Fine :-

--> MVA SECTION: 141. Provisions as to other right to claim compensation for death or permanent disablement.
    - This section is omitted by s.50, ibid, (w.e.f. 1-4-2022).
    - Punishments & Fine :-

--> MVA SECTION: 142. Permanent disablement.
    - This section is omitted by s.50, ibid, (w.e.f. 1-4-2022).
    - Punishments & Fine :-

--> MVA SECTION: 143. Applicability of Chapter to certain claims under Act 8 of 1923.
    - This section is omitted by s.50, ibid, (w.e.f. 1-4-2022).
    - Punishments & Fine :-

--> MVA SECTION: 144. Overriding effect.
    - This section is omitted by s.50, ibid, (w.e.f. 1-4-2022).
    - Punishments & Fine :-
...
--> MVA SECTION: 145. Definitions.
    Definition: This section provides essential definitions for terms used within the chapter on third-party insurance, clarifying their meaning for legal and practical purposes.
...
--> MVA SECTION: 146. Necessity for insurance against third party risks.
    Definition: This section defines that all motor vehicles on Indian roads have third-party insurance. This means that drivers must have an active insurance policy that covers damage to other people or property. 
    ...
    (3) The appropriate Government may, by order, exempt from the operation of sub-section (1), any vehicle owned by any of the following authorities, namely:-
        ...
        (c) any State Transport Undertaking: Provided that no such order shall be made in relation to any such authority unless a fund has been established and is maintained by that authority in such manner as may be prescribed by appropriate Government.
    ...
    - Punishments & Fine :- Maximum fine of two thousand rupees for first offence and four thousand rupees for second or subsequent offence.

--> MVA SECTION: 147. Requirement of policies and limits of liability.
    Definition: This section outlines the necessary requirements for a valid motor insurance policy, including the limits of liability an insurer must cover, essentially stating that every vehicle must be insured by a policy issued by an authorized insurer that covers liability for death, bodily injury, or property damage caused by the vehicle to any third party in a public place; this section essentially mandates compulsory third-party insurance for all motor vehicles. 
...
--> MVA SECTION: 148. Validity of policies of insurance issued in reciprocating countries.
    Definition: This section states that insurance policies issued in reciprocating countries are valid when certain conditions are met. 
...
--> MVA SECTION: 149. Settlement by insurance company and procedure therefore.
    Definition: This section governs the process for insurance companies to settle claims. It states that the insurance company must appoint an officer to settle claims if they get information about an accident. The officer can then make an offer to the claimant to settle the claim. 
...
--> MVA SECTION: 150. Duty of insurers to satisfy judgments and awards against persons insured in respect of third party risks.
    Definition: This section states that insurers must pay judgments and awards against insured people for third party risks. This applies when the insured person becomes insolvent, or if the company is wound up. 
...
--> MVA SECTION: 151. Rights of third party against insurers on insolvency of insured.
    Definition: This section protects the rights of third parties when the insured person becomes insolvent. This section ensures that third parties are compensated for damages caused by the insured person, even if the insured person is unable to pay. 
    (1) Where under any contract of insurance affected in accordance with the provisions of this Chapter, a person is insured against liabilities which he may incure to third party, then-
...
--> MVA SECTION: 152. Duty to give information as to insurance.
    Definition: This section states that if a claim is made against someone regarding a liability covered under the insurance policy, they are obligated to disclose whether they were insured against that liability and provide relevant details about their insurance policy upon request from the person making the claim; essentially, it mandates the duty to provide information about one's motor vehicle insurance when asked in relation to a potential claim.
...
--> MVA SECTION: 153. Settlement between insurers and insured persons.
    Definition: This section deals with settlements between insurers and insured people. It states that settlements must be bona fide and not made under undue influence. 
...
--> MVA SECTION: 154. Saving in respect of sections 151, 152 and 153.
    Definition: This section states that the provisions of sections 151, 152, and 153 apply in certain ways when a person is insured under a policy. 
...
--> MVA SECTION: 155. Effect of death on certain causes of action.
    Definition: This section states that the death of an insured person does not prevent claims from being made against the insurer or the insured's estate. This applies if the death occurs after the event that led to the claim. 
...
--> MVA SECTION: 156. Effect of certificate of insurance.
    Definition: This section states that the certificate is considered to be the policy of insurance if the insurer has issued the certificate but not the policy. 
...
--> MVA SECTION: 157. Transfer of certificate of insurance.
    Definition: This section states that when a vehicle is transferred, the insurance policy is also deemed to be transferred to the new owner. This happens automatically, without any further action required. 
...
--> MVA SECTION: 158. Production of certain certificates, licence and permit in certain cases.
    Definition: This section states that drivers produce certain documents if a police officer requests them. This includes the driver's license, insurance certificate, and vehicle registration certificate. 
...
--> MVA SECTION: 159. Information to be given regarding accident.
    Definition: This section states that a police officer investigating a motor vehicle accident must prepare an "accident information report" containing specific details about the incident, with the primary goal of facilitating the settlement of any subsequent insurance claims related to the accident; this report must be submitted to the Claims Tribunal within three months of the accident occurrence. 
...
--> MVA SECTION: 160. Duty to furnish particulars of vehicle involved in accident.
    Definition: This section states that a registering authority or police officer in charge of a police station must provide details about a vehicle involved in an accident, including identification marks, driver information, and property damage, to anyone claiming compensation related to the accident, upon request and payment of the prescribed fee; essentially, it mandates the authorities to furnish particulars of a vehicle involved in an accident when required for claiming compensation. 
...
--> MVA SECTION: 161. Special provisions as to compensation in case of hit and run motor accident.
    Definition: This section outlines special provisions regarding compensation for victims of hit-and-run motor accidents, stating that the Central Government must provide compensation for death or grievous hurt caused by such accidents, with a fixed sum currently set at Rs. 2 lakhs for death and Rs. 50,000 for grievous hurt; this amount can be revised by the government as per a designated scheme.
...
--> MVA SECTION: 162. Scheme for golden hour.
    Definition: This section means that insurance companies must provide for the cashless treatment of road accident victims during the critical first hour following an accident, known as the "golden hour," and the Central Government is responsible for creating this scheme with provisions for a dedicated fund to facilitate such treatment. 
...
--> MVA SECTION: 163. Refund in certain cases of compensation paid under section 161.
    Definition: This section states that if compensation is paid under Section 161 for a death or injury, any further compensation received must be refunded to the insurer. This applies if the further compensation is received under any other law or provision of the Motor Vehicles Act. 
...
--> MVA SECTION: 164. Payment of compensation in case of death or grevious hurt, etc.
    Definition: This section states that the owner or insurer of a motor vehicle is liable to pay compensation to the legal heirs or victim if someone dies or is seriously injured in an accident. 
...
--> MVA SECTION: 164A. Scheme for interim relief for claimants.
    Definition: This section allows the Central Government to create schemes for providing interim relief to claimants seeking compensation. 
...
--> MVA SECTION: 164B. Motor Vehicle Accident Fund.
    Definition: This section establishes the Motor Vehicle Accident Fund (MVAF). The fund provides compulsory insurance coverage to all road users in India. 
...
--> MVA SECTION: 164C. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules to carry out the provisions of the chapter. These rules can include forms, application processes, and more. 
...
--> MVA SECTION: 164D. Power of State Government to make rules.
    Definition: This section gives state governments the power to make rules to carry out the provisions of the Act.
...
--> MVA SECTION: 165. Claims Tribunals.
    Definition: This section allows state governments to establish Motor Accidents Claims Tribunals (MACTs) to settle claims for compensation. These tribunals deal with claims for injuries, death, or property damage that result from motor vehicle accidents. 
...
--> MVA SECTION: 166. Application for compensation.
    Definition: This section allows people to apply for compensation if they are injured or their property is damaged in a motor accident. 
...
--> MVA SECTION: 167. Option regarding claims for compensation in certain cases.
    Definition: This section allows a person to claim compensation under either the MVA or the Workmen's Compensation Act, 1923, but not both. This section applies when a person's death or injury results in a claim for compensation under both acts. 
...
--> MVA SECTION: 168. Award of the Claims Tribunal.
    Definition: This section deals with the award of compensation by the Claims Tribunal in case of an accident. The Claims Tribunal is a legal body that investigates and decides on compensation for accident claims.
    (1) On receipt of an application for compensation madeunder section 166, the Claims Tribunal shall, after giving notice of the application to the insurer and after giving the parties (including the insurer) an opportunity of being heard, hold an inquiry into the claim or, as the case may be, each of the claims and, subject to the provisions of section 163 may make an award determining the amount of compensation which appears to it to be just and specifying the person or persons to whom compensation shall be paid and in making the award the Claims Tribunal shall specify the amount which shall be paid by the insurer or owner or driver of the vehicle involved in the accident or by all or any of them, as the case may be:
...
--> MVA SECTION: 169. Procedure and powers of Claims Tribunals.
    Definition: This section defines the procedures and powers of Claims Tribunals. The Claims Tribunals are used to adjudicate compensation claims for motor accidents. 
...
--> MVA SECTION: 170. Impleading insurer in certain cases.
    Definition: This section allows the Claims Tribunal to implicate an insurer in a claim if there is collusion between the claimant and the person being claimed against. The insurer can then contest the claim on the same grounds as the person being claimed against. 
    - Where in the course of any inquiry, the Claims Tribunalis satisfied that
...
--> MVA SECTION: 171. Award of interest where any claim is allowed.
    Definition: This section allows a Claims Tribunal to order the payment of interest in addition to compensation. This can happen when a claim for compensation is allowed under the Act. 
...
--> MVA SECTION: 172. Award of compensatory costs in certain cases.
    Definition: This section allows a Claims Tribunal to award "compensatory costs" to a party if the opposing party has presented a false or vexatious claim or defense, essentially penalizing parties who try to mislead the tribunal with frivolous arguments in a motor accident claim case.
...
--> MVA SECTION: 173. Appeals.
    Definition: This section covers appeals from awards made by Claims Tribunals. 
...
--> MVA SECTION: 174. Recovery of money from insurer as arrear of land revenue.
    Definition: This section allows a Claims Tribunal to recover money from an insurer as an arrear of land revenue. This means that the Collector can recover the amount in the same way as land revenue arrears. 
...
--> MVA SECTION: 175. Bar on jurisdiction of Civil Courts.
    Definition: This section prevents civil courts from hearing certain cases that can be handled by a Claims Tribunal. 
    - Where any Claims Tribunal has been constituted for any area, no Civil Court shall have jurisdiction to entertain any question relating to any claim for compensation which may be adjudicated upon by the Claims Tribunal for that area, and no injunction in respect of any action taken or to be taken by or before the Claims Tribunal in respect of the claim for compensation shall be granted by the Civil Court.
    - Punishments & Fine :-

--> MVA SECTION: 176. Power of State Government to make rules.
    Definition: This section gives the state government the power to make rules to carry out the provisions of sections 165 to 174. 
...
--> MVA SECTION: 177. General provision for punishment of offences.
    Definition: This section states that anyone who violates the Act, or any rule, regulation, or notification made under the Act, can be punished. 
...
--> MVA SECTION: 177A. Penalty for contravention of regulations under section 118.
    Definition: This section states that the penalty for breaking the regulations under Section 118 is a fine of at least Rs 500 but no more than Rs 1,000. 
...
--> MVA SECTION: 178. Penalty for travelling without pass or ticket and for dereliction of duty on the part of conductor and refusal to ply contract carriage, etc.
    Definition: This section states that if a person travels on a stage carriage without a valid pass or ticket, or if a conductor fails to perform their duty by not accepting fare, issuing a proper ticket, or checking passes, they can be penalized with a fine that may extend up to five hundred rupees; essentially covering penalties for travelling without a ticket and conductor negligence.
...
--> MVA SECTION: 179. Disobedience of orders, obstruction and refusal of information.
    Definition: This section deals with disobedience of orders, obstruction, and refusal of information. 
...
--> MVA SECTION: 181. Driving vehicles in contravention of section 3 or section 4.
    Definition: This section states that driving a motor vehicle without a valid driving license is an offense.
...
--> MVA SECTION: 182. Offences relating to licences.
    Definition: This section deals with offenses related to driving and conductor's licenses. 
...
--> MVA SECTION: 182A. Punishment for offences relating to construction, maintenance, sale and alteration of motor vehicles and components.
    Definition: This section deals with the punishment for offenses related to the construction, maintenance, sale, and alteration of motor vehicles and their components, essentially penalizing manufacturers, importers, or dealers who sell or alter vehicles that violate the provisions outlined in Chapter VII of the Act or its corresponding rules and regulations; this can include imprisonment up to one year, a fine of one lakh rupees per vehicle, or both depending on the offense severity.
...
--> MVA SECTION: 182B. Punishment for contravention of section 62A.
    Definition: This section states that anyone who contravenes the provisions of Section 62A shall be punishable with a fine, if you violate the rules outlined in Section 62A.
...
--> MVA SECTION: 183. Driving at excessive speed, etc.
    Definition: This section deals with driving at speeds that exceed the speed limit.
...
--> MVA SECTION: 184. Driving dangerously.
    Definition: This section defines dangerous driving as driving in a way that is dangerous to the public. 
...
--> MVA SECTION: 185. Driving by a drunken person or by a person under the influence of drugs.
    Definition: This section prohibits driving a motor vehicle while under the influence of alcohol or drugs. 
...
--> MVA SECTION: 186. Driving when mentally or physically unfit to drive.
    Definition: This section states that driving while mentally or physically unfit to drive is an offense. 
...
--> MVA SECTION: 187. Punishment for offences relating to accident.
    Definition: This section states that driving while mentally or physically unfit to drive is an offense. 
...
--> MVA SECTION: 188. Punishment for abetment of certain offences.
    Definition: This section states that anyone who helps commit an offense under sections 184, 185, or 186 of the MVA will receive the same punishment as the person who committed the offense. 
...
--> MVA SECTION: 189. Racing and trials of speed.
    Definition: This section prohibits racing and trials of speed between motor vehicles in public places without the written consent of the state government. 
...
--> MVA SECTION: 191. Sale of vehicle in or alteration of vehicle to condition contravening this Act.
    - This section is omitted by Act The Motor Vehicles (Amendment) Act, 2019 (32 of 2019), s. 73 (w.e.f. 1-9-2019).
    - Punishments & Fine :- 
...
--> MVA SECTION: 192A. Using vehicle without permit.
    Definition: This section defines the offense of using a vehicle without a permit. This includes using a vehicle in violation of the permit's conditions or using it in a way that's not permitted by the permit. 
...
--> MVA SECTION: 192B. Offences relating to registration.
    Definition: This section covers offenses related to vehicle registration. These include failing to apply for registration, obtaining a registration certificate using false documents, and using a vehicle with a different engine or chassis number than the registered one. 
...
--> MVA SECTION: 193. Punishment of agents, canvassers and aggregators without proper authority.
    Definition: This section deals with the punishment of agents, canvassers, and aggregators who operate without proper authority. 
...
--> MVA SECTION: 194. Driving vehicle exceeding permissible weight.
    Definition: This section covers driving a vehicle that is over the permissible weight. It also applies to vehicles that are loaded in a way that is beyond the permissible height or extends past the side of the body. 
...
--> MVA SECTION: 194A. Carriage of excess passengers.
    Definition: This section states that driving a transport vehicle with more passengers than allowed is punishable with a fine. 
    - Whoever drives a transport vehicle or causes or allows a transport vehicle to be driven while carrying more passengers than is authorised in the registration certificate of such transport vehicle or the permit conditions applicable to such transport vehicle shall be punishable with a fine of two hundred rupees per excess passenger: Provided that such transport vehicle shall not be allowed to move before the excess passengers are off-loaded and an alternative transport is arranged for such passengers.
    - Punishments & Fine :- Maximum fine of twenty thousand rupees for first offence and twenty thousand rupees for second or subsequent offence.

--> MVA SECTION: 194B. Use of safety belts and the seating of children.
    Definition: This section covers the use of safety belts and the seating of children in motor vehicles. It states that drivers and passengers must wear seat belts, and children under 14 must be secured in a safety belt or child restraint system. 
...
--> MVA SECTION: 194C. Penalty for violation of safety measures for motor cycle drivers and pillion riders.
    Definition: This section states that the penalty for violating safety measures while driving a motorcycle is a fine and a license suspension. This applies to both the driver and the pillion rider.
...
--> MVA SECTION: 194E. Failure to allow free passage to emergency vehicles.
    Definition: This section states that drivers must move to the side of the road to allow emergency vehicles to pass. This includes ambulances, fire service vehicles, and other emergency vehicles designated by the state government. 
...
--> MVA SECTION: 194F. Use of horns and silence zones.
    Definition: This section deals with the use of horns and silence zones. It states that using a horn in certain ways is prohibited and can result in a fine. 
    - Whoever -
    ...
    - Punishments & Fine :- Maximum fine of one thousand rupees for first offence and two thousand rupees for second or subsequent offence.

--> MVA SECTION: 195. Imposition of minimum fine under certain circumstances.
    Definition: This section that described the minimum fine for certain offenses but it is omitted by Act The Motor Vehicles (Amendment) Act, 2019 
    - This section is omitted by Act The Motor Vehicles (Amendment) Act, 2019 (32 of 2019), s. 80 (w.e.f. 1-9-2019).
    - Punishments & Fine :-

--> MVA SECTION: 196. Driving uninsured vehicle.
    Definition: This section deals with driving a motor vehicle without insurance. 
...
--> MVA SECTION: 197. Taking vehicle without authority.
    Definition: This section defines that driving away a motor vehicle without the consent of the owner or any other lawful authority, making it a punishable offense under the law essentially, it refers to the act of stealing a vehicle by driving it away without permission from the rightful owner. 
    (1) Whoever takes and drives away any motor vehicle without having either the consent of the owner thereof or other lawful authority shall be punishable with imprisonment which may extend to three months or with fine of five thousand rupees, or with both. Provided that no person shall be convicted under this section if the Court is satisfied that such person acted in the reasonable belief that he had lawful authority or in the reasonable belief that the owner would in the circumstances of the case have given his consent if he had been asked therefore.
...
--> MVA SECTION: 198. Unauthorised interference with vehicle.
    Definition: This section defines "Unauthorised interference with a vehicle" as when someone enters or moves a stationary motor vehicle without lawful authority or reasonable excuse, or tampers with the brake or any part of the vehicle's mechanism, making it punishable by a fine as prescribed by law; essentially meaning you cannot touch or interfere with a parked vehicle without a valid reason.
    - Whoever otherwise than with lawful authority or reasonable execuse enters or mounts any stationary motor vehicle or tampers with the brake or any part of the mechanism of a motor vehicle shall be punishable with fine of one thousand rupees.
    - Punishments & Fine :-

--> MVA SECTION: 198A. Failure to comply with standards for road design, construction and maintenance.
    Definition: This section covers the failure to meet the standards for road design,construction, and maintenance. This includes the failure of designated authorities,contractors, consultants, and concessionaires. 
...
--> MVA SECTION: 199. Offences by companies.
    Definition: This section covers offenses committed by companies. It states that the person in charge of the company at the time of the offense is guilty of the offense. 
...
--> MVA SECTION: 199A. Offences by juveniles.
    Definition: This section deals with offenses committed by juveniles. It states that the guardian or owner of the vehicle can be held liable if a juvenile commits a motor vehicle offense. 
    ...
    Explanation: For the purposes of this section,
        (1) the Court shall presume that the use of the motor vehicle by the juvenile was with the consent of the guardian of such juvenile or the owner of the motor vehicle, as the case may be.
...
--> MVA SECTION: 199B. Revision of fines.
    Definition: This section revises fines annually by up to 10%. This section was added by the Motor Vehicles (Amendment) Act of 2019. 
...
--> MVA SECTION: 200. Composition of certain offences.
    Definition: This section allows for the compounding of certain offenses before or after prosecution. This means that the offense can be settled without going to court. 
...
--> MVA SECTION: 202. Power to arrest without warrant.
    Definition: This section gives police officers the power to arrest without a warrant in certain circumstances. 
...
--> MVA SECTION: 203. Breath tests.
    Definition: This section allows police to ask drivers to perform breath tests. This section applies when a police officer suspects that a driver has alcohol in their blood or is driving under the influence of drugs. 
    (1) A police officer in uniform or an officer of the Motor Vehicles Department, as may be authorised in this behalf by that Department, may require any person driving or attempting to drive a motor vehicle in a public place to provide one or more specimens of breath for breath test there or nearby, if such police officer or officer has any reasonable cause to suspect him of having committed an offence under section 185: Provided that requirement for breath test shall be made (unless, it is made) as soon as reasonably practicable after the commission of such offence.
...
--> MVA SECTION: 204. Laboratory test.
    Definition: This section outlines the procedures and legal standing of blood tests used to determine alcohol levels in drivers suspected of driving under the influence.
...
--> MVA SECTION: 205. Presumption of unfitness to drive.
    Definition: This section states that a person's refusal to take a breath or blood test can be presumed to support the prosecution's case. This presumption can be used to rebut evidence from the defense about the person's condition at the time. 
...
--> MVA SECTION: 206. Power of police officer to impound document.
    Definition: This section gives police officers the power to seize documents related to a vehicle. This includes licenses, permits, registration certificates, and insurance papers. 
...
--> MVA SECTION: 207. Power to detain vehicles used without certificate of registration permit, etc.
    Definition: This section gives police officers the power to detain vehicles that are being used without a valid registration certificate or permit. 
    ...
    - STATE AMENDMENT Rajasthan
        - Amendment of Section 207, Central Act 59 of 1988.
        - In the proviso to sub-section (1) of Section 207 of the principal Act, the expression “or without the permit required by sub- section (1) of Section 66” as occurring between the expression “Section 3 or section 4” and the expression “he may” shall be deleted. [Vide Rajasthan Act 2 of 1993, s. 3].
    - Punishments & Fine :- Punishment as a Court Challan for first and subsequent offence.

--> MVA SECTION: 208. Summary disposal of cases.
    Definition: This section pertains to the "Summary Disposal of Cases," which allows a court to quickly dispose of certain traffic offenses that are not punishable by imprisonment, enabling the accused to plead guilty and pay a fine directly on the summons without a full trial. 
...
--> MVA SECTION: 209. Restriction on conviction.
    Definition: This section restricts convictions for offenses under sections 183 or 184. This means that a person cannot be convicted unless they are warned and given a notice and summons within specific time frames. 
...
--> MVA SECTION: 210. Courts to send intimation about conviction.
    Definition: This section states that courts must send an intimation to the licensing authorities when a person with a driving license is convicted of an offense. The intimation must include details of the offense, the punishment, and other relevant information. 
...
--> MVA SECTION: 210A. Power of State Government to increase penalties.
    Definition: This section gives state governments the power to increase penalties for traffic violations. The state government can do this by specifying a multiplier for each fine. 
...
--> MVA SECTION: 210B. Penalty for offence committed by an enforcing authority.
    Definition: This section states that an authority that enforces the Act will be liable for double the penalty if it commits an offense under the Act. 
    ...
    - Punishments & Fine :- Twice the Penalty corresponding to that an offence under the Act for first, second or subsequent offence.

--> MVA SECTION: 210C. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules for the design, construction, and maintenance of national highways. The Central Government can also make rules for other matters. 
...
--> MVA SECTION: 210D. Power of State Government to make rules.
    Definition: This section gives the state government the power to make rules for the design, construction, and maintenance of roads. The state government can also make rules for other matters that it prescribes. 
...
--> MVA SECTION: 211. Power to levy fee.
    Definition: This section states that a person is required to pay a fee for the registration of each bus. This fee is levied because the RTO provides a service by processing your application, issuing registration certificates, and license plates for your vehicles.
...
--> MVA SECTION: 211A. Use of electronic forms and documents.
    Definition: This section essentially allows for the use of electronic forms and documents, meaning that applications, forms, and other documents related to vehicle registration, driving licenses, and other MVA procedures can be submitted and processed electronically, enabling digital filing and communication with relevant authorities.
...
--> MVA SECTION: 212. Publication, commencement and laying of rules and notifications.
    Definition: This section deals with the publication, commencement, and laying of rules and notifications.
...
--> MVA SECTION: 213. Appointment of motor vehicles officers.
    Definition: This section deals with the appointment of Motor Vehicles Officers (MVOs). The state government can establish a Motor Vehicles Department and appoint MVOs to enforce the Motor Vehicles Act. 
...
--> MVA SECTION: 214. Effect of appeal and revision on orders passed by original authority.
    Definition: This section states that when an appeal or revision application is filed against an order passed by the original authority, the appeal or revision will not automatically stay the original order, meaning the order remains in effect until the appeal or revision is decided, unless the appellate or revisional authority directs otherwise; essentially, the original order continues to operate even while the appeal is being heard. 
...
--> MVA SECTION: 215. Road Safety Councils and Committees.
    Definition: This section establishes road safety councils and committees at the national, state, and district levels. These councils and committees are responsible for developing and implementing road safety programs. 
...
--> MVA SECTION: 215A. Power of Central Government and State Government to delegate. 
    Definition: This section gives the Central and State Governments the power to delegate their functions and powers to public servants or authorities. 
...
--> MVA SECTION: 215B. National Road Safety Board.
    Definition: This section establishes the National Road Safety Board. The board advises the Central and State governments on road safety and traffic management. 
...
--> MVA SECTION: 215C. Power of Central Government to make rules.
    Definition: This section gives the Central Government the power to make rules to carry out the provisions of the Act. The rules can be made by notification in the Official Gazette. 
    (1) The Central Government may make rules for the purposes of carrying into effect the provisions of this Chapter. 
    (2) Without prejudice to the generality of the foregoing power, such rules may provide for- 
...
--> MVA SECTION: 215D. Power of State Government to make rules.
    Definition: This section gives the state government the power to make rules to carry out the provisions of the chapter.
...
--> MVA SECTION: 216. Power to remove difficulties.
    Definition: This section gives the Central Government the power to make provisions to remove difficulties that may arise in implementing the Act. 
...
--> MVA SECTION: 217. Repeal and savings.
    Definition: This section states that the MVA of 1939 and any similar state laws are repealed, but that some aspects of the old laws continue to apply. 
...
--> MVA SECTION: 217A. Renewal of permits, driving licences and registration granted under the Motor Vehicles Act, 1939.
    Definition: This section allows for the renewal of permits, driving licenses, and registrations granted under the Motor Vehicles Act, 1939. 
